...
plot.compass.index<-function(x,roll.mean.n=2,minim=10,maxim=90,b=20,adjust=40){
  ...
  legend.density<-AF.density(x,expand.vector.resolution.minute.level = T)
  ...
  legend("topright", bty="n",c(paste("AF density:",round(legend.density,2))  ,paste("AF burden:",round(burden.pat,2))),cex=1)
  #Starting index
